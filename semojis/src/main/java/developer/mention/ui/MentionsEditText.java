...
import developer.mention.tokenization.interfaces.TokenSource;
 ...
 * <b>XML attributes</b>
 * <p/>
 * See {R.styleable#MentionsEditText Attributes}
 *
...
public class MentionsEditText extends AppCompatEditText implements TokenSource {
    ...
    /**
     * Removes any {@link .MentionsEditText.DeleteSpan}s and the text within them from
     * the given text.
     *
    ...
    /**
     * Replaces any {@link .MentionsEditText.PlaceholderSpan} within the given text with
    ...
    /**
     * Simple implementation of the {@link .MentionsEditText.MentionWatcher} interface
